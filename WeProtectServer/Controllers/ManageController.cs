...
namespace WeProtectServer.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ApplicationDbContext DbContext => Request.GetOwinContext().Get<ApplicationDbContext>();
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.ActivationKeys = (from key in DbContext.ActivationKeys
